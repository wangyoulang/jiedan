...
class HISApplication:
    ...
    def test_db_connection(self):
        ...
        try:
            ...
            # 测试查询Users表
            cursor = conn.cursor()
            cursor.execute("SELECT COUNT(*) as count FROM HIS_A_Users")
    ...
    def show_login(self):
        ...
        # 标题
        title_label = ttk.Label(login_frame, text="医院信息管理系统HIS-A", font=("Arial", 20))
    ...
    def verify_login(self, username, password):
        ...
        try:
            ...
            # 打印实际执行的SQL语句
            sql = "SELECT * FROM HIS_A_Users WHERE username = %s AND password = %s AND status = 1"
