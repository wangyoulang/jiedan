'use strict';
/*
 * run-test-using-node.js - Run the web project #2 test code using Node.js rather than in the
...
console.log('*********** Running web Project #2 tests ***********');

var startingGlobalProperties = Object.keys(global);

console.log('*** Loading project files ....');
processScriptFromFile('./web-make-multi-filter.js');
processScriptFromFile('./web-template-processor.js');

console.log('*** Running tests ....');
processScriptFromFile('./web-test-project2.js');

var p1Message = global.webProject2Results.p1Message;
var p2Message = global.webProject2Results.p2Message;
var p3Message = global.webProject2Results.p3Message;
